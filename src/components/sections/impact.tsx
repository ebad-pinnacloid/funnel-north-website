    ...
    <section className="bg-ink py-16 text-white lg:py-24">
      <Container className="flex flex-col items-center gap-10">
        ...
        <div className="grid w-full gap-5 lg:grid-cols-[420fr_426fr_390fr] lg:gap-[22px]">
          ...
          <Reveal className="flex min-h-[250px] flex-col justify-between rounded-xl bg-brand px-6 pb-5 pt-8 lg:h-80">
            <div>
          ...
          <Reveal delay={0.1} className="reveal-scale relative min-h-[263px] overflow-hidden rounded-xl lg:h-80">
            <Image
